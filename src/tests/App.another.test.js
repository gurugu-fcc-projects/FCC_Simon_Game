...
//   beforeEach(function() {
//     this.component = ReactTestUtils.renderIntoDocument(<App store={store} />);
//     this.renderedDOM = () => ReactDOM.findDOMNode(this.component);
//   });
//
//   it.skip("renders a canvas", function() {
...
//   });
//
//   it.skip("wraps a canvas with a <div> with a proper class name", function() {
